...
| `ERR_AUTH_COMPANY_IN_USE` | `409` | Phân vùng còn người dùng đang hoạt động, không xoá được | Xoá một phân vùng còn người ngoài chính người quản trị của nó. Từ [ADR-0044](../03-decisions/ADR-0044-ngung-su-dung-phan-vung-tach-khoi-xoa.md) mục 5 cửa này cho qua khi phân vùng rỗng người, hoặc còn đúng một người và người đó mang cờ `is_admin` |
| `ERR_AUTH_COMPANY_IS_CURRENT` | `409` | Không làm được thao tác này trên phân vùng bạn đang làm việc | Bấm Ngừng sử dụng hoặc Xoá lên chính phân vùng của actor ([ADR-0044](../03-decisions/ADR-0044-ngung-su-dung-phan-vung-tach-khoi-xoa.md) mục 4). Ra ở **cả hai** đường `PUT /companies/:id/active` và `DELETE /companies/:id`: tiền đề "cửa còn người dùng đã bắt trước" hết hiệu lực từ mục 5 của cùng ADR, khi cửa ấy được nới cho phân vùng còn đúng một người quản trị |
