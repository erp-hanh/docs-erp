...
| `ERR_AUTH_COMPANY_IS_CURRENT` | `409` | Không ngừng sử dụng được phân vùng bạn đang làm việc | Bấm Ngừng sử dụng lên chính phân vùng của actor ([ADR-0044](../03-decisions/ADR-0044-ngung-su-dung-phan-vung-tach-khoi-xoa.md) mục 4). Đường xoá không có cửa này vì cửa "còn người dùng" đã bắt trước |
